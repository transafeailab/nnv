function example_nonlinear_reach_ARCH18_laubLoomis_small()
% example_nonlinear_reach_ARCH18_laubLoomis_small - example of 
% nonlinear reachability analysis when initial set is small
%
% Syntax:  
...
options.R0=zonotope([options.x0,0.01*eye(dim)]); %initial state for reachability analysis
...
options.maxError = 0.1*ones(dim,1);
