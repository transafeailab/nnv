...
parfor i=1:N1
    for j=1:N2
        for k=1:N3
            t = tic;
            [riou, rv, rs, ~, ~, ~, ~, ~] = net3.verify(IS(i), GrTruth{1,i}, Methods(j), numCores, RFs(k));
...
writetable(N3_verifyTime);


N3_verifyTime_improve = table;
N3_verifyTime_improve.RelaxFactor = RFs;
impr = [];
for i=1:N2
    vt1 = VT(1, i, :);
    vt1 = reshape(vt1, [N3, 1]);
...
N3_verifyTime_improve.de_005 = impr;
...
N3_verifyTime_improve.de_01 = impr;
...
N3_verifyTime_improve.de_02 = impr;

N3_verifyTime_improve
writetable(N3_verifyTime_improve);
...
for i=1:N
    [rf, a11, a12, a21, a22, a31, a32, a41, a42, b11, b12, b21, b22, b31, b32, b41, b42, c11, c12, c21, c22, c31, c32, c41, c42] = get_verifyTime(N3_verifyTime, N3_verifyTime_improve, i);
    if i== 1
        str = sprintf('\\\\multirow{5}{*}{$\\\\mathbf{N_3}$} & $%2.2f$ & %2.2f &  $%2.2f$  &  $%2.2f$ &  $%2.2f$  & $%2.2f$  &  $%2.2f$  &  $%2.2f$  &  $%2.2f$  &  $%2.2f$ &  $%2.2f$  &  $%2.2f$  &  $%2.2f$ \\\\\\\\ ', rf, a11, a21, a31, a41, b11, b21, b31, b41, c11, c21, c31, c41); 
    else
