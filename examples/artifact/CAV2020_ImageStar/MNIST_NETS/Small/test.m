...
% 
% fprintf('\n========================================================================================');
% fprintf('\n                VERIFICATION TIMES (IN SECONDS) OF SMALL_CONVNET                        ');
% fprintf('\n========================================================================================\n\n');
% 
% 
% for j=1:M
...
% 
% %% Print to file
% fid = fopen([path_out, 'table1_Small_ConvNet_Results.txt'], 'wt');
% fprintf(fid,'\n========================================================================================');
% fprintf(fid,'\n          ROBUSTNESS VERIFICATION RESULTS (IN PERCENT) OF SMALL_CONVNET                 ');
% fprintf(fid,'\n========================================================================================\n\n');
% 
...
% 
% %% Print latex table
% fid = fopen([path_out, 'table1_Small_ConvNet_Results.tex'], 'wt');
% fprintf(fid,'\nRobustness results\n');
% for i=1:P
%     fprintf(fid, '$d = %d$', d(i));
%     for j=1:M
